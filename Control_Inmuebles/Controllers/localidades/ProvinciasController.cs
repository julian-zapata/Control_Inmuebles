...
namespace Control_Inmuebles.Controllers.localidades
{
    public class ProvinciasController : Controller
    {
        ...
        public ProvinciasController(Control_InmueblesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaisId,Id,Descripcion")] Provincia provincia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaisId,Id,Descripcion")] Provincia provincia)
        {
            if (id != provincia.Id)
            {
                return NotFound();
